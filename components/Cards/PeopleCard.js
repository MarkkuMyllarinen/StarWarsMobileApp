...
// image urlien saaminen tuotti yllättäviä haasteita, ei ollut saatavilla ilmaista Apia millä olisi 
// näin paljon kuvia hakea. Käytin sitten python taitoja ja azure bing image searchia missä siinäkin raja 1000
// ja per sekuntti 3 hakua, ja tein pythonilla listan valmiiksi urleista ja nimistä mitä voin käyttää
let image_urls = {
      ...
      <View>
        ...
        >
            ...
            <View style={{ flexDirection: "row", marginTop: 40 }}>
              <Image
                source={{ uri: image_urls[route.item.name] }}
                resizeMode="contain"
                style={styles.image}
              ></Image>
              <View style={{ flexDirection: "column" }}>
                <Text style={styles.infoText}>{route.item.name}</Text>
              </View>
            </View>
        </ImageBackground>
      </View>
